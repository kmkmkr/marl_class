...
def main() -> None:
    ...
    train_parser.add_argument(
        "--use_error_reward",
        action="store_true",
        dest="use_error_reward",
        help="Use error reward",
    )
    train_parser.add_argument(
        "--use_attn_reward",
        action="store_true",
        dest="use_attn_reward",
        help="Use attention reward",
    )
    train_parser.add_argument(
        "--vit_repo_or_dir",
        type=str,
        default="facebookresearch/dino:main",
        dest="vit_repo_or_dir",
        help="Vit repository or directory",
    )
    train_parser.add_argument(
        "--vit_name",
        type=str,
    ...
    train_parser.add_argument(
        ...
        type=str,
        default="",
        dest="attn_reward_path",
        help="Attention reward path",
    )
    ...
    match args.main_choice:
        case "train":
            ...
            train_options = TrainOptions(
                ...
                args.ft_extractor,
                args.gamma,
                args.use_error_reward,
                args.use_attn_reward,
                args.vit_repo_or_dir,
                args.vit_name,
                args.attn_reward_path,
            )
